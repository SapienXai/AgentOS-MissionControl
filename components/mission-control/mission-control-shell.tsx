      ...
      <div className="relative flex min-h-screen flex-col gap-4 px-4 pb-4 pt-5 lg:h-screen lg:block lg:px-0 lg:pb-0 lg:pt-0">
        ...
        >
          ...
          >
            ...
            <div className="pointer-events-none absolute inset-x-0 top-0 z-50 flex items-center justify-between px-2 pt-2 lg:px-0 lg:pt-6">
              <div
                className={cn(
              ...
              <div ref={settingsRef} className="pointer-events-auto relative hidden lg:block">
                <div
                  className={cn(
                    "flex h-11 items-center gap-3 rounded-full border px-4 shadow-[0_18px_50px_rgba(0,0,0,0.24)] backdrop-blur-xl",
                    surfaceTheme === "light"
                    ...
                    {snapshot.diagnostics.updateAvailable && snapshot.diagnostics.latestVersion ? (
                      ...
                      >
                        ...
                        <button
                          ...
                          className={cn(
                            "mt-3 inline-flex items-center justify-center rounded-[14px] border px-2.5 py-1.5 text-[10px] uppercase tracking-[0.22em] transition-colors disabled:cursor-wait disabled:opacity-70",
                            surfaceTheme === "light"
                        ...
                        >
                          {updateRunState === "running" ? "Updating..." : "Update now"}
                        </button>
                      </div>
                    ) : null}
