...
```bash
curl -fsSL https://raw.githubusercontent.com/SapienXai/AgentOS/main/install.sh | AGENTOS_VERSION=0.3.10 bash
```

Windows PowerShell:

```powershell
$env:AGENTOS_VERSION='0.3.10'; iwr https://raw.githubusercontent.com/SapienXai/AgentOS/main/install.ps1 | iex
```
...
```bash
git tag agentos-v0.3.10
git push origin agentos-v0.3.10
```
