...
- Use the recommended OpenClaw 2026.9.2. The supported minimum is OpenClaw 2026.9.1 after explicit session-security reconciliation; the native contract target is 2026.9.2.
